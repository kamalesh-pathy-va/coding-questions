'''
This is a problem from codewars.com
...
osition and value of the beginning of the plateau. For example: pickPeaks([1, 2, 2, 2, 1])
...
def main():
	print(pick_peaks([int(x) for x in input().split()]))
